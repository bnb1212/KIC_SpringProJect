...
public class Admin_VideoDto {
	...
	public String getVideo_class_no() {
		return video_class_no;
	}

	public void setVideo_class_no(String video_class_no) {
		this.video_class_no = video_class_no;
	}
